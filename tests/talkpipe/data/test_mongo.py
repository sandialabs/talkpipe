...
class TestMongoInsert:
    ...
    def test_unique_constraint(self):
        ...
        test_data = [
            ...
            },  # Same email, should cause duplicate key error
        ]
    ...
    def test_connection_from_config(self, monkeypatch):
        ...
        segment = MongoInsert(database=TEST_DB_NAME, collection=TEST_COLLECTION)
    ...
    def test_invalid_parameters(self):
        ...
        with pytest.raises(ValueError, match="Database name is required"):
            MongoInsert(
                connection_string=TEST_CONNECTION_STRING, collection=TEST_COLLECTION
            )

        # Test missing collection
        with pytest.raises(ValueError, match="Collection name is required"):
            MongoInsert(connection_string=TEST_CONNECTION_STRING, database=TEST_DB_NAME)
