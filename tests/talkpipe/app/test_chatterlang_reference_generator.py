...
class TestParamSpec:
    ...
    def test_init_with_values(self):
        ...
        param = ParamSpec(
            name="test_param", annotation="str", default='"default_value"'
        )
        assert param.name == "test_param"
...
class TestAnalyzeFunctions:
    ...
    def test_analyze_registered_items(
        ...
        mock_segment_registry.all.items.return_value = [
            ("mockSegment", mock_segment_class)
        ]
    ...
    def sample_items(self):
        ...
        return [
            AnalyzedItem(
                ...
                parameters=[ParamSpec("param1", "str", '"default"')],
                chatterlang_name="testSource",
                decorator_type="source",
                is_source=True,
            ),
            AnalyzedItem(
                ...
                parameters=[ParamSpec("param1", "int", "42")],
...
class TestMainFunctions:
    ...
    def test_go_default_args(self, mock_main):
        ...
        mock_main.assert_called_once_with(
            "./chatterlang_ref.html", "./chatterlang_ref.txt"
        )
    ...
    def test_go_custom_args(self, mock_main):
        ...
        mock_main.assert_called_once_with("custom.html", "custom.txt")
