...
class TestTalkpipePluginManager:
    ...
    def test_list_plugins_success_only(
        self, mock_stdout, mock_list_failed, mock_list_loaded
    ):
    ...
    @patch("sys.stdout", new_callable=StringIO)
    @patch("sys.argv", ["talkpipe_plugin_manager", "--list"])
    def test_list_plugins_with_failures(
        self, mock_stdout, mock_list_failed, mock_list_loaded
    ):
    ...
    def test_list_and_reload_combined(
        self, mock_stdout, mock_get_plugin_loader, mock_list_failed, mock_list_loaded
    ):
