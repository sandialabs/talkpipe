...
class TestTalkPipeBrowser:
    ...
    def test_load_components_with_mock_data(
        self,
        mock_extract,
        mock_segment_registry,
        mock_input_registry,
        mock_load_plugins,
    ):
        ...
        mock_segment_registry.all.items.return_value = [
            ("testSegment", mock_segment_class)
        ]
    ...
    def test_run_list_modules(
        self, mock_input, mock_segment_registry, mock_input_registry, mock_load_plugins
    ):
    ...
    @patch("talkpipe.app.chatterlang_reference_browser.segment_registry")
    @patch("builtins.input")
    def test_run_search_components(
        self, mock_input, mock_segment_registry, mock_input_registry, mock_load_plugins
    ):
    ...
    @patch("talkpipe.app.chatterlang_reference_browser.input_registry")
    @patch("talkpipe.app.chatterlang_reference_browser.segment_registry")
    def test_show_component_not_found(
        self, mock_segment_registry, mock_input_registry, mock_load_plugins
    ):
    ...
    @patch("talkpipe.app.chatterlang_reference_browser.input_registry")
    @patch("talkpipe.app.chatterlang_reference_browser.segment_registry")
    def test_show_component_case_insensitive(
        self, mock_segment_registry, mock_input_registry, mock_load_plugins
    ):
        ...
        # Add test component
        test_doc = TalkPipeDoc(
            "ReadEmail", ["readEmail"], "Source", "email.module", [], "Read emails", {}
        )
