...
├── Step_1_ExecutiveSummaryGeneration.sh            # Executive summary launcher (Linux/macOS)
├── Step_1_ExecutiveSummaryGeneration.bat           # Executive summary launcher (Windows)
├── Step_1_ExecutiveSummaryGeneration.script        # Executive summary ChatterLang script
├── Step_2_DetailedAnalysisReportGeneration.sh      # Detailed reports launcher (Linux/macOS)
├── Step_2_DetailedAnalysisReportGeneration.bat     # Detailed reports launcher (Windows)
├── Step_2_DetailedAnalysisReportGeneration.script  # Detailed analysis ChatterLang script
├── Step_3_MultiFormatReportGeneration.sh           # Multi-format launcher (Linux/macOS)
├── Step_3_MultiFormatReportGeneration.bat          # Multi-format launcher (Windows)
