...
class ChatterlangServer:
    ...
    def __init__(
        ...
        host: str = "localhost",
        port: int = 9999,
        api_key: str | None = "your-secret-key-here",
    ...
    def _generate_form_fields(self) -> str:
        ...
        for field in self.form_config.fields:
            ...
            if field.type == "select" and field.options:
                ...
                default_val = (
                    f'value="{field.default}"' if field.default is not None else ""
                )
...
def go() -> None:
    ...
    parser.add_argument(
        "--require-auth", action="store_true", help="Require API key authentication"
    )
    parser.add_argument(
        "--title",
        default=None,
