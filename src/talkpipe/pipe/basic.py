...
@segment()
def isIn(items, field, value, as_filter=True, append_as=None):
...
@segment()
def isNotIn(items, field, value, as_filter=True, append_as=None):
...
@segment()
def isFalse(items, as_filter=True, field="_", append_as=None):
    """
