...
class ExpiringDict(UserDict[Any, Any]):
    ...
    def __init__(
        ...
        # Mutations, expiry sweeps and the whole-file save are serialized so
        # concurrent writers cannot interleave a half-updated dict into the
        # JSON on disk (or corrupt data/expiry relative to each other).
