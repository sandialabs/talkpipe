...
# Local Hugging Face embedding settings (used by talkpipe.llm.embedding_adapters_local)
...
LOCAL_EMBEDDING_TRUST_REMOTE_CODE = "LOCAL_EMBEDDING_TRUST_REMOTE_CODE"
LOCAL_EMBEDDING_NORMALIZE = "LOCAL_EMBEDDING_NORMALIZE"
